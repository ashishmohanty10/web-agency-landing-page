  ...
  return (
    <>
      <Container>
        ...
        <div className="flex items-center justify-between w-full h-[60rem] gap-5 mb-15">
          <div className="w-1/2 border border-black/5 rounded-2xl shadow-lg h-[60rem] overflow-hidden">
            <Feature className="p-5 space-y-3">
              <Title className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <WebsiteDesign className="font-bold text-brand w-6 h-6" />
                  Website Design
                </div>
          ...
          <div className="w-1/2 h-full flex flex-col gap-y-5">
            <div className="h-fit border border-black/5 rounded-2xl shadow-lg">
              <Feature className="p-5 space-y-3">
                <Title className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
            ...
            <div className="h-full flex-1 border border-black/5 rounded-2xl shadow-lg overflow-hidden">
              <Feature className="p-5 space-y-3">
                <Title className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          {service.map((item) => (
            <div
              key={item.label}
              className="py-4 px-5 border border-black/10 rounded-2xl flex items-center gap-2"
            >
              <item.icon className="text-brand w-7 h-7" />
