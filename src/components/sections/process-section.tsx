    ...
    <Container>
      ...
      >
        ...
        <motion.div
          ...
          className="w-full md:flex items-center justify-between mb-8"
        >
        ...
        <motion.div
          variants={containerVariants}
          className="grid grid-cols-1 lg:grid-cols-2 justify-between w-full gap-5"
        >
          <motion.div
            variants={cardItemVariants}
            className="w-full border border-black/5 rounded-2xl shadow-md"
          >
            ...
            <div className="flex items-start w-full p-2">
              <div className="flex flex-col justify-between p-5 w-[90%]">
                ...
                <div>
                  ...
                  <SubTitle>
                    Our skilled developers bring your designs to life, crafting
            ...
            <div className="flex items-start w-full p-2">
              <div className="flex flex-col justify-between p-5 w-[90%]">
                ...
                <div>
                  ...
                  <SubTitle>
                    Receive a fully tested, polished & quality product that
                    meets your needs with ongoing support.
                  </SubTitle>
                </div>
              </div>
